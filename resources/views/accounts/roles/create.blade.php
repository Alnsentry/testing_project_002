...
<div class="text-center mb-4">
    <h3 class="role-title">Tambah Hak Akses Baru</h3>
    <p>Atur izin hak akses</p>
</div>
<!-- Add role form -->
<form class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" method="POST" action="{{ route('access-rights.store') }}">
    @csrf
    <div class="col-12 mb-4 fv-plugins-icon-container">
    <label class="form-label" for="name">Nama Hak Akses</label>
    <input type="text" id="name" name="name" :value="old('name')" required autofocus autocomplete="name" class="form-control" placeholder="Enter a role name" tabindex="-1">
        ...
        <table class="table table-flush-spacing">
            <tbody>
                        ...
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%dashboard-%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="dashboard{{ ucfirst(explode('-', $value->name)[1]) }}">
                    ...
                    <td>
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%laporan-rutin-%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="laporanRutin{{ ucfirst(explode('-', $value->name)[2]) }}">
                    ...
                    <td>
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%laporan-grouncheck-hotspot-%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="laporanGrouncheckHotspot{{ ucfirst(explode('-', $value->name)[3]) }}">
                    ...
                    <td>
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%laporan-info-kebakaran-%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="laporanInfoKebakaran{{ ucfirst(explode('-', $value->name)[3]) }}">
                    ...
                    <td>
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%laporan-pemadaman-%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="laporanPemadaman{{ ucfirst(explode('-', $value->name)[2]) }}">
                    ...
                    <td>
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%history-pesan-%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="historiPesan{{ ucfirst(explode('-', $value->name)[2]) }}">
                    ...
                    <td>
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%whatsapp-kontak-%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="kontak{{ ucfirst(explode('-', $value->name)[2]) }}">
                    ...
                    <td>
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%whatsapp-kirim-pesan-%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="kirimPesan{{ ucfirst(explode('-', $value->name)[3]) }}">
                    ...
                    <td>
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%data-master-provinsi-%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="provinsi{{ ucfirst(explode('-', $value->name)[3]) }}">
                    ...
                    <td>
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%data-master-daop-%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="daop{{ ucfirst(explode('-', $value->name)[3]) }}">
                    ...
                    <td>
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%data-master-pondok-kerja-%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="pondokKerja{{ ucfirst(explode('-', $value->name)[4]) }}">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%akun-role-%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="roleManagement{{ ucfirst(explode('-', $value->name)[2]) }}">
                                    <label class="form-check-label" for="roleManagement{{ ucfirst(explode('-', $value->name)[2]) }}">
                                        {{ ucfirst(explode("-", $value->name)[2]) }}
                                    </label>
                                </div>
                            @endforeach
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                        @foreach(Spatie\Permission\Models\Permission::where('name','like','%akun-staff-%')->get() as $value)
                            <div class="form-check me-3 me-lg-5">
                            <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="staffManagement{{ ucfirst(explode('-', $value->name)[2]) }}">
                            <label class="form-check-label" for="staffManagement{{ ucfirst(explode('-', $value->name)[2]) }}">
                                {{ ucfirst(explode("-", $value->name)[2]) }}
                            </label>
                            </div>
                        @endforeach
                    ...
                    <td>
                        <div class="d-flex">
                            @foreach(Spatie\Permission\Models\Permission::where('name','like','%qrcode%')->get() as $value)
                                <div class="form-check me-3 me-lg-5">
                                    <input name="permission[]" class="form-check-input" type="checkbox" value="{{$value->id}}" id="logoSetting{{ ucfirst(explode('-', $value->name)[1]) }}">
